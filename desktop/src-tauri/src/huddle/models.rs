...
///
/// Includes the attribution sidecar written by ABY during install. The
...
(https://github.com/k2-fsa/sherpa-onnx); ABY ships this conversion
unmodified.
...
impl ModelManager {
    ...
    ///   - upstream `LICENSE` plus ABY's `MODEL_LICENSE.txt` attribution sidecar
