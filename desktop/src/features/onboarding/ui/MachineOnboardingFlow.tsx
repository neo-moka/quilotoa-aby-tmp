...
import { LandingHoneycomb } from "./LandingHoneycomb";
import {
  NostrKeyImportForm,
...
export function MachineOnboardingFlow({
  ...
  return (
    ...
    >
      ...
      {page === "identity" ? <LandingHoneycomb /> : null}
      ...
      <OnboardingFooterProvider backAction={chromeBackAction}>
        ...
        >
          {page === "identity" ? (
            ...
            >
              <h1 className="buzz-landing-wordmark text-9xl font-semibold leading-none tracking-tight text-foreground">
                ABY
              </h1>
              <p className="mt-6 max-w-[560px] text-center text-2xl font-normal leading-none text-foreground">
              ...
              >
                ...
                <div className="mt-5 max-w-[440px] text-sm leading-6 text-foreground/80">
                  {keyImportStage === "backup-password" ? (
                    ...
                    <p>
                      Paste your private key to sign in to ABY. You can also use
                      a{" "}
                      <button
                ...
                >
                  <div className="mx-auto w-full max-w-[35rem] pb-6 pt-10 text-center max-sm:pb-4 max-sm:pt-6">
                    ...
                    <DialogDescription className="mx-auto mt-4 max-w-[28rem] text-sm leading-6 text-foreground/80">
                      Choose the encrypted backup file you saved from ABY.
                    </DialogDescription>
                    <NostrKeyImportForm
                      footerMode="inline"
                      mode="backup"
