...
test("parsePromptText wraps header-less free text in a single Prompt section", () => {
  ...
  // userText is empty and the title falls through to "ABY event".
  ...
  assert.equal(result.userTitle, "ABY event");
...
test("parsePromptText defaults the title to 'ABY event' when no kind is present", () => {
