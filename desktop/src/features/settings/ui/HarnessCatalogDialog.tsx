    ...
    <Dialog onOpenChange={onOpenChange} open={open}>
      ...
      >
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-sidebar sm:flex-row">
          ...
          {/* Right: detail pane */}
          <div className="relative z-10 ml-px flex min-h-0 flex-1 flex-col overflow-hidden rounded-tl-xl bg-background shadow-[-1px_0_0_0_hsl(from var(--sidebar-border) h s l / 0.45)]">
            <div
