...
before(() => {
  Object.assign(globalThis, {
    ...
    // The buttons here render React Aria's press handling, whose teardown
    // narrows event targets with `target instanceof SVGElement`; without the
    // global that throws from inside cleanup rather than from an assertion.
