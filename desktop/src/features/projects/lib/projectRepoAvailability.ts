...
> = {
  authentication: {
    description:
      "ABY could not authenticate with this repository. Check your access and try again.",
    title: "Repository access failed",
  },
  missing: {
    description:
      "The project announcement exists, but its git repository was not found on the ABY relay.",
  ...
  network: {
    description:
      "The ABY git service could not be reached. Check your connection and try again.",
  ...
  unknown: {
    description:
      "ABY could not load this repository. Try again or contact the project owner.",
