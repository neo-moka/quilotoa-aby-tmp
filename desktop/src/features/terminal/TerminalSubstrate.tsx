...
export function TerminalSubstrate({
   ...
   * ownership: in ABY mode these keys belong to the rest of the app.
   */
    ...
    >
      ...
      <div className="buzz-terminal-contract-bar">
        ...
        <div className="buzz-terminal-readout">
          <button
            aria-label={
              mode === "maximized" ? "Restore ABY Term" : "Maximize ABY Term"
            }
      ...
      <div aria-live="polite" className="sr-only">
        {owner === "terminal" ? "ABY Term mode" : "ABY mode"}
      </div>
    </section>
  );
}
